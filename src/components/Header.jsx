...
const Header = () => {
  ...
  const navStyle =
    "text-stone-50 px-3 py-1 rounded-md text-sm font-medium transition duration-300 ease-in-out hover:text-black hover:bg-[#ECB602] active:bg-sky-500";

  return (
    <nav className="bg-[#55185D]">
