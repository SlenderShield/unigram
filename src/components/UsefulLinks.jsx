...
export default function UsefulLinks() {
  ...
  return (
    <section className="bg-gray-300 p-8">
      ...
      <div className="card">
        <Carousel circular={true} autoplayInterval={3000} value={UsefulLinkImages} numVisible={3} numScroll={3} responsiveOptions={responsiveOptions} itemTemplate={linkTemplate} />
      </div>
    </section>
  )
}
